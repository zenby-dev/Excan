-- GLON: Garrysmod Lua Object Notation
...
-- Types:
	...
	-- 255: reference (Sends the ID of the table to use (for "local t = {} t.a=t"))if SERVER then
local pairs = pairs
local type = type
local string = string
local math = math
...
encode_types = {
	...
	number = {6, function(o)
		o = o == 0 and "" or o
		return o == math.huge and "" or tostring(o).."\1", math.huge and 254
	end},
	string = {7, function(o)
